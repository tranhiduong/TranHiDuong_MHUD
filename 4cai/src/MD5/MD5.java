...
public class MD5 extends javax.swing.JFrame {
    ...
    private void btnGiaimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiaimaActionPerformed
        ...
        String goc=txtChuoi.getText();
        
        if(getMd5(mahoa.toString()).equals(goc))
        {
            JOptionPane.showMessageDialog(null, "Không bị thay đổi",
                "Done",JOptionPane.INFORMATION_MESSAGE);
        }else
        {
            JOptionPane.showMessageDialog(null, "Đã bị thay đổi",
                "Done",JOptionPane.INFORMATION_MESSAGE);
        }
