    ...
    private void btnMahoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMahoaActionPerformed
        ...
        if(rdbFile.isSelected()==true){
            ...
            if(writeByFile(file.getAbsolutePath()+".mahoa.txt", data)&&
                writeObjectFile(file.getAbsolutePath()+".key.txt",des.getKey()))
            {
                file.delete();
            ...
            data = des.EnCrypt(data);
                if(writeByFile1(data)&&writeObjectFile1(des.getKey()))
                {
